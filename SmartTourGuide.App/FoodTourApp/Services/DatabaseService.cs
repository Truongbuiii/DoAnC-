...
namespace FoodTourApp.Services
{
    public class DatabaseService
    {
        ...
        private List<POI> GetMultiLanguagePOIs()
        {
            return new List<POI>
            {
                new POI { PoiId=1, Name="Cổng chào Phố ẩm thực", Category="Điểm tham quan",
                    TriggerRadius=50, Latitude=10.761858, Longitude=106.702236,
                    ImageSource="cong_chao.jpg", // ✅ khớp SQL Server
                ...
                new POI { PoiId=2, Name="Dê Chung", Category="Lẩu dê",
                    TriggerRadius=35, Latitude=10.761500, Longitude=106.702600,
                    ImageSource="laubo.jpg", // ✅ khớp
                ...
                new POI { PoiId=3, Name="Ốc Vũ 37", Category="Hải sản",
                    TriggerRadius=35, Latitude=10.761403, Longitude=106.702705,
                    ImageSource="ocvu.jpg", // ✅ khớp
                ...
                new POI { PoiId=4, Name="Bún cá Châu Đốc Dì Tư", Category="Bún cá",
                    TriggerRadius=30, Latitude=10.761200, Longitude=106.703100,
                    ImageSource="bunmam.jpg", // ✅ khớp
                ...
                new POI { PoiId=5, Name="Ốc Thảo 123", Category="Hải sản",
                    TriggerRadius=35, Latitude=10.760750, Longitude=106.704600,
                    ImageSource="octhao123.jpg", // ✅ sửa
                ...
                new POI { PoiId=6, Name="Sushi KO", Category="Đồ Nhật",
                    TriggerRadius=30, Latitude=10.760739, Longitude=106.704651,
                    ImageSource="sushi.jpg", // ✅ khớp
                ...
                new POI { PoiId=7, Name="Chilli Lẩu Nướng 232", Category="Lẩu nướng",
                    TriggerRadius=35, Latitude=10.760900, Longitude=106.703800,
                    ImageSource="launuong.jpg", // ✅ sửa
                ...
                new POI { PoiId=8, Name="Ốc Đào 2", Category="Hải sản",
                    TriggerRadius=30, Latitude=10.760820, Longitude=106.703500,
                    ImageSource="ocdao.jpg", // ✅ sửa
                ...
                new POI { PoiId=9, Name="Ốc Thảo 383", Category="Hải sản",
                    TriggerRadius=30, Latitude=10.760770, Longitude=106.703400,
                    ImageSource="octhao383.jpg", // ✅ sửa
                ...
                new POI { PoiId=10, Name="Ốc Oanh 534", Category="Hải sản",
                    TriggerRadius=40, Latitude=10.760719, Longitude=106.703297,
                    ImageSource="ocoanh.jpg", // ✅ khớp
